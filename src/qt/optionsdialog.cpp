    ...
    mapper(0)
{
    ...
    /* Theme selector */
    /*ui->theme->addItem(QString("USERV-light"), QVariant("light"));*/
    ui->theme->addItem(QString("USERV-blue"), QVariant("drkblue"));
    /*ui->theme->addItem(QString("USERV-Crownium"), QVariant("crownium"));*/
    ui->theme->addItem(QString("USERV-traditional"), QVariant("trad"));
