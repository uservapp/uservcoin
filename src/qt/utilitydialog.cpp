    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("UservCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About UservCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  uservcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the UservCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 USERV, 0.1 USERV, 1 USERV and 10 USERV -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://uservcoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://uservcoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("UservCoin Core is shutting down...") + "<br /><br />" +
