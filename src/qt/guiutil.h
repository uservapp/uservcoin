...
/** Utility functions used by the UservCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render USERV addresses in monospace font
...
// Parse "uservcoin:" URI into recipient object, return true on successful parsing
