    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("UservCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UservCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and uservcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About UservCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about UservCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for UservCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UservCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UservCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a uservcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the UservCoin Core help message to get a list with possible UservCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("UservCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to UservCoin network", "", count));
}
...
{
    QString strTitle = tr("UservCoin Core"); // default title
    ...
    // Append title to "UservCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
