...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a USERV address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About UservCoin Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for UservCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your USERV addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified USERV addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the UservCoin Core help message to get a list with possible UservCoin command-line options"));
