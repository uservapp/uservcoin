...
2. run uservcoind with -printalert or -sendalert like this:
   /path/to/uservcoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.uservcoin.site";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/UservCoin Core:0.12.0.58/"));
