 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called UservCoin (https://www.uservcoin.site/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (fDaemon)
        {
            fprintf(stdout, "UservCoin Core server starting\n");
...
int main(int argc, char* argv[])
{
    ...
    // Connect uservcoind signal handlers
    noui_connect();
