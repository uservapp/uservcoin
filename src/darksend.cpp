...
{
    if(fLiteMode) return; // ignore all UservCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat UservCoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("uservcoin-privatesend");
