 ...
 *
 *   // network
 *   CUservCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.uservcoin.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CUservCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CUservCoinNetwork(UniValue objIn)
    {
...
// // can be under: UservCoinNetwork
// //   -- signature requirements : Key1(User)
// class CUservCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == UservCoinNetwork);
//     // }
