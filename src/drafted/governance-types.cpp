...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "UservCoinNetwork") type = UservCoinNetwork;
    if(strType == "UservCoinNetworkVariable") type = UservCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == UservCoinNetwork) s = "UservCoinNetwork";
    if(type == UservCoinNetworkVariable) s = "UservCoinNetworkVariable";
