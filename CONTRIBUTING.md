Contributing to UserV Core
==================================

The UserV Core project operates an open contributor model where anyone is
...
The following applies to code changes to the UserV Core project, and is not to be
confused with overall UserV Network Protocol consensus changes.

Whether a pull request is merged into UserV Core rests with the project merge
...
Patches that change UserV consensus rules are considerably more involved than
...
Where a patch set proposes to change the UserV consensus, it must have been
...
The project leader is the release manager for each UserV Core release.
