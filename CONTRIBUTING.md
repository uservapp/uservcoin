...
The UservCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the UservCoin Core project, and is not to be
confused with overall UservCoin Network Protocol consensus changes.

Whether a pull request is merged into UservCoin Core rests with the project merge
...
Patches that change UservCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the UservCoin consensus, it must have been
