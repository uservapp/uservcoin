...
#   c) node1 mines 32 blocks, so now node 0 has 500000USERV, node 1 has 4250USERV, node2 has none.
#   d) node0 sends 601 USERV to node2, in two transactions (301 USERV, then 300 USERV).
