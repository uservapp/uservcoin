...
In order to support loading of multiple wallets in uservcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is uservcoin.cpp.
...
Changes to uservcoin.cpp
----------------------
uservcoin.cpp is the entry point into uservcoin-qt, and as such, will require some minor modifications to provide hooks for
