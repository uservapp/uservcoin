...
In order to support loading of multiple wallets in userv-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is userv.cpp.
...
Changes to userv.cpp
----------------------
userv.cpp is the entry point into userv-qt, and as such, will require some minor modifications to provide hooks for
