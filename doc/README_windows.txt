...
Intro
-----
UserV (USERV) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. UserV utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run userv-qt.exe.

UserV Core is the original UserV client and it builds the backbone of the network.
However, it downloads and stores the entire history of UserV transactions;
