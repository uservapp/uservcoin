...
This mechanism has been integrated into Bitcore-Node-UservCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/uservcoincoin/insight-api-uservcoin#web-socket-api](https://github.com/uservcoincoin/insight-api-uservcoin#web-socket-api) 
* API: [https://github.com/uservcoincoin/insight-api-uservcoin#instantsend-transactions](https://github.com/uservcoincoin/insight-api-uservcoin#instantsend-transactions) 
...
By default, the UservCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the UservCoin Core daemon:
