...
* Update translations see [translation_process.md](https://github.com/uservapp/uservcoin/blob/master/doc/translation_process.md#synchronising-translations).
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import uservcoin/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Verify the signatures
    ...
    ./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-aarch64 ../uservcoin/contrib/gitian-descriptors/gitian-aarch64.yml
    popd
...
space *do not upload these to the uservcoin.com server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/uservapp/uservcoin/releases/new) with a link to the archived release notes.
